...
to establish a set of relevant studies:
...
The complete set of keywords is as follows:
...
burgeoning interest in LLM-based agentic technologies \citep{agents} (the technique
