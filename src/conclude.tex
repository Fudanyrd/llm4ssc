...
\begin{itemize}
  ...
  have to be followed by thorough investigation of veteran developers
  in case of incorrect content.
 ...
 attacks and low-quality training data, so that the safety of LLM-generated
  ...
  should enhance scrutiny of published software packages, possibly
